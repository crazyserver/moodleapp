...
import { AddonCalendarEventDBRecord, AddonCalendarFilter } from '../types';
...
declare module '@singletons/events' {
    ...
    export interface CoreEventsData {
        [ADDON_CALENDAR_NEW_EVENT_EVENT]: AddonCalendarUpdatedEventEvent;
        [ADDON_CALENDAR_EDIT_EVENT_EVENT]: AddonCalendarUpdatedEventEvent;
        [ADDON_CALENDAR_DELETED_EVENT_EVENT]: AddonCalendarUpdatedEventEvent;
        [ADDON_CALENDAR_UNDELETED_EVENT_EVENT]: AddonCalendarUpdatedEventEvent;
