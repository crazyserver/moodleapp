...
import { COURSE_ALL_COURSES_CLEARED, COURSE_ALL_SECTIONS_ID } from '@features/course/constants';
...
export class AddonStorageManagerCourseStoragePage implements OnInit, OnDestroy {
    ...
    protected async initCoursePrefetch(): Promise<void> {
        ...
        this.courseStatusObserver = CoreEvents.on(CoreEvents.COURSE_STATUS_CHANGED, (data) => {
            if (data.courseId === this.courseId || data.courseId === COURSE_ALL_COURSES_CLEARED) {
