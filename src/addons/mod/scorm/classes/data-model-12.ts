...
export class AddonModScormDataModel12 {
    ...
    constructor(
        ...
        protected mode = AddonModScormMode.MODENORMAL,
    ...
    protected init(userData: AddonModScormUserDataMap): void {
        ...
        for (const scoId in this.def) {
            ...
            this.currentUserData[scoId].userdata['cmi.core.credit'] = this.mode == AddonModScormMode.MODENORMAL ?
                'credit' :
                'no-credit';
    ...
    protected storeData(storeTotalTime?: boolean): boolean {
        ...
        if (storeTotalTime) {
            ...
            if (this.getEl('cmi.core.lesson_mode') == AddonModScormMode.MODENORMAL) {
            ...
            if (this.getEl('cmi.core.lesson_mode') == AddonModScormMode.MODEBROWSE) {
