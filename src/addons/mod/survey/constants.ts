...
// Handlers.
export const ADDON_MOD_SURVEY_PREFETCH_NAME = ADDON_MOD_SURVEY_COMPONENT_LEGACY;
export const ADDON_MOD_SURVEY_PREFETCH_MODNAME = ADDON_MOD_SURVEY_MODNAME;
export const ADDON_MOD_SURVEY_PREFETCH_COMPONENT = ADDON_MOD_SURVEY_COMPONENT_LEGACY;
