...
import { ADDON_MOD_ASSIGN_FEATURE_NAME, ADDON_MOD_ASSIGN_FEEDBACK_HANDLERS } from '../constants';
...
export class AddonModAssignFeedbackDelegateService extends CoreDelegate<AddonModAssignFeedbackHandler> {
    ...
    constructor(
        ...
        super('AddonModAssignFeedbackDelegate', ADDON_MOD_ASSIGN_FEEDBACK_HANDLERS);
    }
