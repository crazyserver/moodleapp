...
export class CoreDomUtilsProvider {
     ...
     * @returns Promise resolved when done.
     *
     * @deprecated since 4.5. Use CoreDom.waitForResizeDone instead.
     */
    async waitForResizeDone(windowWidth?: number, windowHeight?: number, retries = 0): Promise<void> {
        return CoreDom.waitForResizeDone(windowWidth, windowHeight, retries);
    }
 ...
 *
 * @deprecated since 4.5. Use CoreModals.OpenModalOptions instead.
 */
export type OpenModalOptions = OpenModalOptionsNew;
