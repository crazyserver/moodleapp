...
import {
    CoreText,
    defaultTextFormat as defaultTextFormatNew,
} from '@singletons/text';
import { CoreViewer, CoreViewerTextOptions } from '@features/viewer/services/viewer';
import { CoreErrorHelper, CoreTextErrorObject as CoreTextErrorObjectNew } from '@services/error-helper';
import { CoreSitesHelper } from '@services/sites-helper';

/**
 * Different type of errors the app can treat.
 *
 * @deprecated since 4.5. Use CoreError.CoreTextErrorObject instead.
 */
export type CoreTextErrorObject = CoreTextErrorObjectNew;
...
export class CoreTextUtilsProvider {
     ...
     */
    addTextToError(
        error: string | CoreError | CoreTextErrorObjectNew | undefined | null,
        text: string,
    ): string | CoreTextErrorObjectNew {
     ...
     */
    addTitleToError(error: string | CoreError | CoreTextErrorObjectNew | undefined | null, title: string): CoreTextErrorObjectNew {
     ...
     */
    buildSeveralParagraphsMessage(paragraphs: (string | CoreTextErrorObjectNew)[]): string {
     ...
     *
     * @deprecated since 4.5. Use CoreSitesHelper.treatDisabledFeatures instead.
     */
    treatDisabledFeatures(features: string): string {
        return CoreSitesHelper.treatDisabledFeatures(features);
    }
     ...
     * @param text Text to treat.
     * @returns Treated text.
     * @deprecated since 4.5. Use CoreText.ucFirst instead.
     */
    ucFirst(text: string): string {
        return CoreText.ucFirst(text);
    }
 ...
 *
 * @deprecated since 4.5. Use CoreText.CoreTextFormat instead.
 */
...
/**
 * @deprecated since 4.5. Use CoreText.defaultTextFormat instead.
 */
export const defaultTextFormat = defaultTextFormatNew;
