...
export class CoreCourseHelperProvider {
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.calculateSectionStatus instead.
     */
    async calculateSectionStatus(
        ...
        return CoreCoursePrefetch.calculateSectionStatus(
            section,
            courseId,
            refresh,
            checkUpdates,
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.confirmAndPrefetchCourse instead.
     */
    async confirmAndPrefetchCourse(
        ...
        await CoreCoursePrefetch.confirmAndPrefetchCourse(data, course, options);
    }
     ...
     * @param options Other options.
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.confirmAndPrefetchCourses instead.
     */
    async confirmAndPrefetchCourses(
        courses: CoreCourseAnyCourseData[],
        options: CoreCourseConfirmPrefetchCoursesOptions = {},
    ): Promise<void> {
        await CoreCoursePrefetch.confirmAndPrefetchCourses(courses, options);
    }
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.confirmDownloadSizeSection instead.
     */
    async confirmDownloadSizeSection(
        ...
        await CoreCoursePrefetch.confirmDownloadSizeSection(courseId, sections, alwaysConfirm);
    }
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.downloadModuleAndOpenFile instead.
     */
     ...
     * @returns Promise resolved when done.
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.downloadModuleWithMainFileIfNeeded instead.
     */
     ...
     * @param siteId The site ID. If not defined, current site.
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.downloadModule instead.
     */
    async downloadModule(
        ...
        await CoreCoursePrefetch.downloadModule(
            module,
            courseId,
            component,
            componentId,
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.initPrefetchCoursesIcons instead.
     */
    ...
    async prefetchCourses(
        ...
        await CoreCoursePrefetch.prefetchCourses(courses, prefetch);
    }
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getCourseDownloadPromise instead.
     */
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getCourseStatusIconAndTitle instead.
     */
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getCoursePrefetchStatusInfo instead.
     */
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getModulePrefetchInfo instead.
     */
     ...
     * @returns Promise resolved with the info.
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getModulePackageLastDownloaded instead.
     */
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.getSectionDownloadId instead.
     */
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.prefetchModule instead.
     */
    async prefetchModule(
        ...
        await CoreCoursePrefetch.prefetchModule(handler, module, size, courseId, refresh);
    }
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.prefetchSections instead.
     */
    async prefetchSections(
        ...
        await CoreCoursePrefetch.prefetchSections(sections, courseId, updateAllSections);
    }
     ...
     * @param courseId Course id.
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.deleteCourseFiles instead.
     */
    async deleteCourseFiles(courseId: number): Promise<void> {
        await CoreCoursePrefetch.deleteCourseFiles(courseId);
    }
     ...
     *
     * @deprecated since 5.1. Use CoreCoursePrefetch.removeModuleStoredData instead.
     */
    async removeModuleStoredData(module: CoreCourseModuleData, courseId: number): Promise<void> {
        await CoreCoursePrefetch.removeModuleStoredData(module, courseId);
    }
