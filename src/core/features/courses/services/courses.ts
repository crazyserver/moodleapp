...
export class CoreCoursesProvider {
     ...
     * @deprecated since 5.0. Use isDownloadCourseDisabledInSite instead.
     */
     ...
     * @param siteId Site Id. If not defined, use current site.
     * @returns Promise resolved with true if disabled, rejected or resolved with false otherwise.
     * @deprecated since 5.0. Use isDownloadCoursesDisabledInSite instead.
     */
     ...
     * @param siteId Site Id. If not defined, use current site.
     * @returns Promise resolved with true if disabled, rejected or resolved with false otherwise.
     * @deprecated since 5.0. Use isMyCoursesDisabledInSite instead.
     */
     ...
     * @param siteId Site Id. If not defined, use current site.
     * @returns Promise resolved with true if disabled, rejected or resolved with false otherwise.
     * @deprecated since 5.0. Use isSearchCoursesDisabledInSite instead.
     */
     ...
     * @deprecated since 5.0. Use getCourses instead. This function will be protected.
     */
